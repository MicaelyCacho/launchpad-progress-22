		...
		extend: {
			...
			colors: {
				...
				performance: {
					...
					'excellent-foreground': 'hsl(var(--performance-excellent-foreground))',
					good: 'hsl(var(--performance-good))',
					'good-foreground': 'hsl(var(--performance-good-foreground))',
					reasonable: 'hsl(var(--performance-reasonable))',
					'reasonable-foreground': 'hsl(var(--performance-reasonable-foreground))'
				}
			},
			borderRadius: {
				lg: 'var(--radius)',
